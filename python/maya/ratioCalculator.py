...
class ApertureTool(object):
	...
	def apertureToolwindow(self, cam):
		...
		if MAYA_VERSION in ('2008', '2008.2', '2008.5'):
			cmds.iconTextRadioButton('vb', e = True, i = MAYA_PICTURES+'/ratioCalculator_v_2008.xpm')
			cmds.iconTextRadioButton('hb', e = True, i = MAYA_PICTURES+'/ratioCalculator_h_2008.xpm')
		if MAYA_VERSION in ('2011', '2011.2', '2011.3', '2011.5', '2012'):
			cmds.iconTextRadioButton('vb', e = True, i = MAYA_PICTURES+'/ratioCalculator_v_2011.tif')
			cmds.iconTextRadioButton('hb', e = True, i = MAYA_PICTURES+'/ratioCalculator_h_2011.tif')
